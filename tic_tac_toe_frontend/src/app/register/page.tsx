...
export default function RegisterPage() {
  ...
  async function onSubmit(e: React.FormEvent) {
    ...
    try {
      // First register
      await registerUser(username as string, password as string);
  ...
  return (
    <div className="min-h-[70vh] flex flex-col items-center justify-center">
      ...
      >
        <h2 className="font-bold text-2xl text-accent text-center">Register</h2>
        {error && (
        ...
        <button
          type="submit"
          className="mt-4 w-full bg-accent text-white py-2 rounded hover:bg-accent/80 font-bold"
        >
          Register
        </button>
        <a href="/login" className="text-xs text-primary text-center hover:underline">
